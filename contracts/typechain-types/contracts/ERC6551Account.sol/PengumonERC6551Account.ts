...
export interface PengumonERC6551AccountInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "execute"
      | "isValidSignature"
...
export interface PengumonERC6551Account extends BaseContract {
  connect(runner?: ContractRunner | null): PengumonERC6551Account;
  waitForDeployment(): Promise<this>;

  interface: PengumonERC6551AccountInterface;
